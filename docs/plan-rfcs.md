...
| **B4b** | QUIC transport (quinn) behind a feature flag; self-signed peer-pinned certs | RFC drafted at [`rfc-b4b-quic.md`](rfc-b4b-quic.md); implementation breaks into B4b-1..B4b-5 (~5 staged PRs); not started |
