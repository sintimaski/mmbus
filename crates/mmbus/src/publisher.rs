...
impl Publisher {
    ...
    pub fn stats(&self) -> TopicStats {
        TopicStats {
            ...
            full_rejected_total: self.full_rejected_total.load(AtomicOrdering::Relaxed),
            subscribers_dropped_total: self.subscribers_dropped_total.load(AtomicOrdering::Relaxed),
