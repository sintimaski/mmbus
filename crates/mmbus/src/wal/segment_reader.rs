...
use crate::wal::record::{
    Record, SegmentHeader, SegmentHeaderError, MAX_RECORD_LEN, RECORD_FRAMING, SEGMENT_HEADER_LEN,
};
...
fn read_one_record(
    ...
    let stored_crc =
        u32::from_le_bytes(body_and_crc[body_len..total_after_len].try_into().unwrap());
